...
scatac_file = pd.read_csv(input_path+'GSE155178_ACR_x_cell.binary.sparse.txt.gz',sep='\t',header = None)
...
# delete "CB:Z:" and save the real cell barcode info
...
for t in tissue_list:
    ...
    tissue_df.to_csv(output_path+'GSE155178_'+t+'_real_frg.tsv.gz', sep="\t",index = False, header = False,compression='gzip')
